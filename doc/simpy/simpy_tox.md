...
Testing started at 12:45 AM ...
.package create: /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.package
.package installdeps: setuptools>=42, setuptools_scm[toml]>=3.4, wheel
...
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
py36 inst: /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1+g2973dbe.tar.gz
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
py36 installed: attrs==21.2.0,importlib-metadata==4.4.0,iniconfig==1.1.1,packaging==20.9,pluggy==0.13.1,py==1.10.0,py-cpuinfo==8.0.0,pyparsing==2.4.7,pytest==6.2.4,pytest-benchmark==3.4.1,simpy @ file:///home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1%2Bg2973dbe.tar.gz,toml==0.10.2,typing-extensions==3.10.0.0,zipp==3.4.1
py36 run-test-pre: PYTHONHASHSEED='1740922349'
...
====================== 139 passed, 10 deselected in 2.58s ======================
...
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
py37 inst: /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1+g2973dbe.tar.gz
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
py37 installed: attrs==21.2.0,importlib-metadata==4.4.0,iniconfig==1.1.1,packaging==20.9,pluggy==0.13.1,py==1.10.0,py-cpuinfo==8.0.0,pyparsing==2.4.7,pytest==6.2.4,pytest-benchmark==3.4.1,simpy @ file:///home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1%2Bg2973dbe.tar.gz,toml==0.10.2,typing-extensions==3.10.0.0,zipp==3.4.1
PASSED                      [ 89%]PASSED                     [ 89%]PASSED          [ 90%]PASSED                                   [ 91%]PASSED                         [ 92%]PASSED                          [ 93%]PASSED                          [ 97%]PASSED             [ 97%]PASSED                             [ 98%]PASSED                             [ 99%]PASSED                         [100%]py37 run-test-pre: PYTHONHASHSEED='1740922349'
...
====================== 139 passed, 10 deselected in 2.66s ======================
...
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
py38 inst: /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1+g2973dbe.tar.gz
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
py38 installed: attrs==21.2.0,iniconfig==1.1.1,packaging==20.9,pluggy==0.13.1,py==1.10.0,py-cpuinfo==8.0.0,pyparsing==2.4.7,pytest==6.2.4,pytest-benchmark==3.4.1,simpy @ file:///home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1%2Bg2973dbe.tar.gz,toml==0.10.2
...
PASSED                            [ 86%]PASSED                      [ 87%]PASSED                                [ 87%]PASSED                          [ 93%]PASSED     [ 94%]PASSED             [ 94%]PASSED                                   [ 95%]py38 run-test-pre: PYTHONHASHSEED='1740922349'
...
====================== 139 passed, 10 deselected in 2.43s ======================

PASSED                  [  7%]PASSED                   [ 15%]PASSED                                   [ 21%]PASSED                 [ 28%]PASSED                     [ 35%]PASSED                         [ 43%]PASSED   [ 50%]PASSED [ 65%]PASSED     [ 72%]PASSED               [ 79%]pypy3 create: /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/pypy3
pypy3 installdeps: pytest, pytest-benchmark
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
pypy3 inst: /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1+g2973dbe.tar.gz
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
pypy3 installed: attrs==21.2.0,cffi==1.14.5,greenlet==0.4.13,importlib-metadata==4.4.0,iniconfig==1.1.1,packaging==20.9,pluggy==0.13.1,py==1.10.0,py-cpuinfo==8.0.0,pyparsing==2.4.7,pytest==6.2.4,pytest-benchmark==3.4.1,readline==6.2.4.1,simpy @ file:///home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1%2Bg2973dbe.tar.gz,toml==0.10.2,typing-extensions==3.10.0.0,zipp==3.4.1
docs create: /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/docs
docs installdeps: pytest, pytest-benchmark
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
docs inst: /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1+g2973dbe.tar.gz
WARNING: Discarding $PYTHONPATH from environment, to override specify PYTHONPATH in 'passenv' in your configuration.
docs installed: attrs==21.2.0,importlib-metadata==4.4.0,iniconfig==1.1.1,packaging==20.9,pluggy==0.13.1,py==1.10.0,py-cpuinfo==8.0.0,pyparsing==2.4.7,pytest==6.2.4,pytest-benchmark==3.4.1,simpy @ file:///home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/.tmp/package/1/simpy-4.0.2.dev1%2Bg2973dbe.tar.gz,toml==0.10.2,typing-extensions==3.10.0.0,zipp==3.4.1
PASSED                          [ 93%]pypy3 run-test-pre: PYTHONHASHSEED='1740922349'
pypy3 run-test: commands[0] | /home/cwm/git/git.c-w-m/sim_dev/src/simpy/.tox/pypy3/bin/python /opt/pycharm-community-2021.1/plugins/python-ce/helpers/pycharm/_jb_pytest_runner.py --offset 40001 -- --doctest-glob= tests
Launching pytest with arguments --doctest-glob= tests --no-header --no-summary -q in /home/cwm/git/git.c-w-m/sim_dev/src/simpy
...
README.rst::README.rst PASSED                                            [  5%]
docs/index.rst::index.rst PASSED                                         [ 10%]
docs/examples/code/bank_renege.py::/home/cwm/git/git.c-w-m/sim_dev/src/simpy/docs/examples/code/bank_renege.py 
docs/examples/code/carwash.py::/home/cwm/git/git.c-w-m/sim_dev/src/simpy/docs/examples/code/carwash.py PASSED [ 21%]
docs/examples/code/gas_station_refuel.py::/home/cwm/git/git.c-w-m/sim_dev/src/simpy/docs/examples/code/gas_station_refuel.py PASSED [ 26%]
docs/examples/code/latency.py::/home/cwm/git/git.c-w-m/sim_dev/src/simpy/docs/examples/code/latency.py PASSED [ 31%]
docs/examples/code/machine_shop.py::/home/cwm/git/git.c-w-m/sim_dev/src/simpy/docs/examples/code/machine_shop.py 
docs/examples/code/movie_renege.py::/home/cwm/git/git.c-w-m/sim_dev/src/simpy/docs/examples/code/movie_renege.py 
docs/examples/code/process_communication.py::/home/cwm/git/git.c-w-m/sim_dev/src/simpy/docs/examples/code/process_communication.py 
docs/simpy_intro/basic_concepts.rst::basic_concepts.rst PASSED           [ 52%]
docs/simpy_intro/process_interaction.rst::process_interaction.rst PASSED [ 57%]
docs/simpy_intro/shared_resources.rst::shared_resources.rst PASSED       [ 63%]
docs/topical_guides/environments.rst::environments.rst PASSED            [ 68%]
docs/topical_guides/events.rst::events.rst PASSED                        [ 73%]
docs/topical_guides/monitoring.rst::monitoring.rst PASSED                [ 78%]
docs/topical_guides/process_interaction.rst::process_interaction.rst PASSED [ 84%]
docs/topical_guides/real-time-simulations.rst::real-time-simulations.rst PASSED [ 89%]
docs/topical_guides/resources.rst::resources.rst PASSED                  [ 94%]
docs/topical_guides/simpy_basics.rst::simpy_basics.rst 

============================== 19 passed in 2.02s ==============================

PASSED [ 15%]PASSED [ 36%]PASSED [ 42%]PASSED [ 47%]Exception ignored in: <generator object Car.run at 0x7f1e427c2dd0>
Traceback (most recent call last):
  File "<doctest process_interaction.rst[6]>", line 13, in run
NameError: name 'simpy' is not defined
PASSED            [100%]flake8 run-test-pre: PYTHONHASHSEED='1740922349'
flake8 run-test: commands[0] | flake8

mypy run-test-pre: PYTHONHASHSEED='1740922349'
